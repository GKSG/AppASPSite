...
namespace WebApplication1.Taskes.Matches
{
    ...
    public class MatchesWord : MatchesTask
    {
        ...
        public MatchesWord(Random task, Random word, Repository repo) : this()
        {
            string current;
            int tagInd, wordInd;
    ...
    public class MatchesImage : MatchesTask
    {
        ...
        public MatchesImage(Random task, Random word, Repository repo) : this()
        {
            string current;
            int tagInd, wordInd;
            for (var i = 0; i < ContentLeft.Length; i++)
    ...
    public class MatchesHard : MatchesTask
    {
        ...
        public MatchesHard(Random task, Random word, Repository repo) : this()
        {
            string current;
            int tagInd, wordInd;
            for (var i = 0 ; i < ContentLeft.Length ; i++)
